...
## Branch info
This branch of the Vector source code will attempt to reimpliment Cozmo from old versions of Cozmoware into the modern os. This branch while being the most stable will not be updated as much as the unstable branch that is found at [Victorware-2.0-tester](https://github.com/Switch-modder/Viccyware-2.0/tree/Victorware-2.0-tester)
